package cn.cnic.dp.common.datetime;
...
import cn.cnic.dp.common.CommonsException;
...
public abstract class DateUtils {
	...
	public static final String[] DATE_PARSE_PATTERNS = { DateTimeUtils.ISO_DATE_FORMAT,
			DateTimeUtils.CUSTOM_DATETIME_FORMAT };
	...
	public static String getDateString(Date date) {
		return dateToString(date, DateTimeUtils.ISO_DATE_FORMAT);
	}
	...
	public static String getDateString(Calendar calendar) {
		return dateToString(calendar, DateTimeUtils.ISO_DATE_FORMAT);
	}
	...
	public static String getDateTimeString(Date date) {
		return dateToString(date, DateTimeUtils.CUSTOM_DATETIME_FORMAT);
	}
	...
	public static String getDateTimeString(Calendar calendar) {
		return dateToString(calendar, DateTimeUtils.CUSTOM_DATETIME_FORMAT);
	}
